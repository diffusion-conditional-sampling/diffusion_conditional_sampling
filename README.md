...
```bash
mkdir -p models/
# Download ffhq_10m.pt
wget -P models/ <URL_TO_FFHQ_10M>
# Download imagenet256.pt
wget -P models/ <URL_TO_IMAGENET256>
# Download ffhq_ldm.ckpt (for latent experiments only)
wget -P models/ <URL_TO_FFHQ_LDM>
```
