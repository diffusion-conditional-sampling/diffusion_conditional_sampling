...
parser.add_argument('--outdir', help='Output directory', default='/mnt/bn/us-aigc-temp/henry/unilatent_weights/rebuttal/test/', type=str)
...
parser.add_argument('--data_root', help='Data location', default='/mnt/bn/us-aigc-temp/henry/unilatent_weights/', type=str)
parser.add_argument('--model_root', help='Model location', default='/mnt/bn/us-aigc-temp/henry/unilatent_weights/models/', type=str)
